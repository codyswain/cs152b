...
LAB93:    if (*((unsigned int *)t13) < *((unsigned int *)t25))
        goto LAB91;
...
LAB73:    xsi_set_current_line(106, ng6);
    ...
    t159 = *((char **)t158);
    memset(t160, 0, 8);
    xsi_vlog_unsigned_minus(t160, 32, t157, 32, t159, 8);
    memset(t161, 0, 8);
    t158 = (t144 + 4);
...
LAB78:    if (*((unsigned int *)t144) > *((unsigned int *)t160))
        goto LAB76;
...
LAB97:    xsi_set_current_line(113, ng6);
    ...
    t141 = (t135 + 56U);
    t142 = *((char **)t141);
    xsi_vlog_generic_convert_array_indices(t46, t48, t102, t112, 2, 2, t134, 9, 2, t142, 9, 2);
    t143 = (t46 + 4);
    t28 = *((unsigned int *)t143);
    t29 = (!(t28));
    t145 = (t48 + 4);
    t31 = *((unsigned int *)t145);
    t32 = (!(t31));
    t33 = (t29 && t32);
    if (t33 == 1)
        goto LAB98;
...
LAB98:    t34 = *((unsigned int *)t46);
    t35 = *((unsigned int *)t48);
    t36 = (t34 - t35);
    t37 = (t36 + 1);
    xsi_vlogvar_assign_value(t89, t83, 0, *((unsigned int *)t48), t37);
    goto LAB99;
